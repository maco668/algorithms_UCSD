...
public class StronglyConnected { 
	...
	private static void Explore(ArrayList<Integer>[] adj, int vertex, boolean[] visited, ArrayList<Integer> order){
		...
		order.add(vertex); // add vertex in the order of ascending postnumber
		//for(int i : order)
	...
	private static void previsit(int vertex){//update pre-order number
		pre[vertex] = clock;
		++clock; 
	}
	
	private static void postvisit(int vertex){//update post-order number
		//System.out.println();
